...
namespace BackEnd.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("cac/{password?}")]
        public async Task<IActionResult> Post(User _userData, string password)
        {

            if (_userData != null && _userData.UserMail != null && password != null)
            {
                var user = await GetUser(_userData.UserMail, password);
